...
interface MyPlaylistsContentProps {
  userId: string;
  isTeacher?: boolean;
}

export function MyPlaylistsContent({ userId, isTeacher }: MyPlaylistsContentProps) {
      ...
      <div className="flex items-center justify-between">
        ...
        <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>
                {editingPlaylist ? t('editPlaylist') : t('createNewPlaylist')}
              </DialogTitle>
              <DialogDescription>
                {editingPlaylist 
                  ? t('updatePlaylistDetails') 
            ...
            <DialogFooter>
              ...
              <Button onClick={handleCreateOrUpdate}>
                {editingPlaylist ? t('update') : t('create')}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold">{t('liked')}</h2>
                        <p className="text-white/80 text-sm">{t('likedDesc')}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 mt-4 text-sm text-white/90">
                      <div className="flex items-center gap-1">
                        <Play className="w-4 h-4" />
                        {likedPlaylist.totalItems} {t('items')}
                      </div>
